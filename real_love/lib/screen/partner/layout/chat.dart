...
import 'package:real_love/screen/partner/widget/FullPhoto.dart';
import 'package:real_love/screen/video_call/layout/calldial.dart';
...
class Chat extends StatelessWidget {
  ...
  Chat({Key key, @required this.peerId, @required this.peerAvatar, this.name}) : super(key: key);
          ...
          children: <Widget>[
            ...
            Expanded(
              child: GestureDetector(
                child: SizedBox(
                  child: SvgPicture.asset('assets/icons/relove_cameravd.svg', height: 40, width: 40, color: Colors.white,),
                ),
                onTap: () {
                  calltofriends(id: peerId);
                  swipetoScreen(context: context, id: peerId);
                },
              ),
            )
          ],
  ...
  void calltofriends({String id}) async {
    final FirebaseAuth firebaseAuth = FirebaseAuth.instance;
    await FirebaseApi.calling(firebaseAuth?.currentUser.uid, id,);
  }

  void swipetoScreen({BuildContext context, String id}) {
    Navigator.push(context, MaterialPageRoute(builder: (context) => DialScreen(id: id,)));
  }
}
